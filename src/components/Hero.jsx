  ...
  return (
    ...
    >
      <div className="py-6 md:order-1 md:block">
        <img src="/logo.webp" alt="logo" width="500px" height="500px" className="rounded-3xl"/>
      </div>
      <div className="mt-4 mx-8">
        <h1 className="text-4xl text-center lg:text-4xl xl:text-6xl font-bold lg:tracking-tight xl:tracking-tighter text-green-700">
